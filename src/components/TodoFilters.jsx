    ...
    <div className='flex items-center justify-center'>
      <div className='inline-flex bg-gray-200 rounded-lg p-1'>
        {filters.map(({ key, label, icon: Icon, count }) => {
          return (
            <button className={`flex items-center gap-2 px-2 py-2 rounded-md text-sm font-medium transation-all duration-200 ${currentFilter === key ? "bg-white text-gray-800 shadow-md" : "text-gray-700 hover:text-gray-800 hover:bg-gray-300"}`}
              key={key}
